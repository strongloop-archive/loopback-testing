...
2. Mocha will be used to run the tests. If you have mocha installed
  as a global npm module or as a devDependency, that's great! Simply 
  update `<your_project>/package.json` with:
